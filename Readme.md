...
[travis-image]: https://travis-ci.com/htmlacademy-javascript/{{userId}}-{{projectName}}.svg?branch=master
[travis-url]: https://travis-ci.com/htmlacademy-javascript/{{userId}}-{{projectName}}
